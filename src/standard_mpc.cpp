...
const std::string keys =
  ...
  "{@config-path   | /home/hyc/10/sp_vision_25_fjut_tuned/configs/standard4.yaml  | yaml配置文件路径 }";
...
int main(int argc, char * argv[])
{
  ...
  while (!exiter.exit()) {
    ...
    /// 打符
      ...
      auto power_runes = buff_detector.detect(img);   //  PowerRune powerrune(fanblades, r_center, last_powerrune_);
