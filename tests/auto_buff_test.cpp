...
const std::string keys =
  ...
  "{@input-path    |       /home/hyc/10/sp_vision_25_fjut_tuned/002.mp4                 | avi和txt文件的路径}";
...
int main(int argc, char * argv[])
{
  ...
  std::string video_path = "/home/hyc/10/sp_vision_25_fjut_tuned/002.mp4";
  std::string text_path = "/home/hyc/10/sp_vision_25_fjut_tuned/002.txt";
